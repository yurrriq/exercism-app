...
{
  [context evaluateScript:[NSString stringWithFormat:@"goog.require('%@');", [self munge:@"exercism.core"]]];
}
...
- (void)contentDidAppear
{
  ...
  [[rootView.bridge moduleForName:@"RCTEventDispatcher"] sendInputEventWithName:@"dummy" body:@{@"target": @1}];
